...
For quick testing on the live demo, you can use these sample credentials:
...
> **Note**: If these test accounts don't exist on the live demo, please create them following the steps above.
...
│   │   ├── providers/              # Providers list page
│   │   ├── settings/               # Settings pages
│   │   │   └── availability/       # Provider availability settings
...
│   │   └── ValidationProgressBar.tsx # Form validation indicator
...
Update appointment (status, notes, prescription).
...
#### GET `/api/patients`
Get list of patients (Provider only).
